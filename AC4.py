...
def ler_notas():
    ...
    """
    ap1 = float(input("Insira a sua nota da AP1: "))
    ap2 = float(input("Insira a sua nota da AP2: "))
    asub = float(input("Insira a sua nota da AS: "))
...
def notas_sao_validas(ap1, ap2, asub, ac):
    ...
    if 0<= ap1 and ap1 <=10 and 0<= ap2 and ap2 <=10 and 0<= asub and asub <=10 and 0<= ac and ac <=10:
        return True
    else:
        return False
